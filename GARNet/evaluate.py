...
if __name__ == '__main__':
	...
	parser.add_argument('-p','--pred_file', type = str,
						default="C:/Users/Administrator/Desktop/GRN_inference_result-hESC.csv",
                        help='Path to inferred results file. Required. \n')
	parser.add_argument('-n','--network', type = str,
                        default = "C:/Users/Administrator/Desktop/500_ChIP-seq_hESC/500_ChIP-seq_hESC-network.csv",
